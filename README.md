...
<body>
    ...
    <script>
        ...
        async function translateText() {
            ...
            const apiKey = "AQ.Ab8RN6L8YYNU1zH1XSm_fzjVhC39ijNoEd8UQ5NAz9kBeDn-iA";
                        ...
                        contents: [
                            {
                                parts: [
                                    {
                                        text: "אתה כלי תרגום להודעות ארוכות וחופרות של תנועות נוער. תחלץ אך ורק את השורה התחתונה, המשימות, השעות, המקומות והלבוש, ותציג אותם בנקודות קצרות וישירות בלי הקדמות.\n\nהודעה:\n" + text
                                    }
                                ]
                            }
                        ]
