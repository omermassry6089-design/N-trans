                ...
                const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
                    ...
                    body: JSON.stringify({
                        ...
                        messages: [
                            {
                                role: "system",
                                content: "אתה כלי תרגום להודעות ארוכות וחופרות של תנועות נוער. תחלץ אך ורק את השורה התחתונה, המשימות, השעות, המקומות והלבוש, ותציג אותם בנקודות קצרות וישירות בלי הקדמות."
                            },
                            {
                                role: "user",
                                content: text
